 ...
 * @author nzayatz14
 */
public class CupGame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		Image img = new ImageIcon(getClass().getResource("imgres.jpg")).getImage();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CupGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
